...
public class RestaurantRepositoryImpl implements RestaurantRepository {
    ...
    public Optional<Restaurant> findRestaurantInformation(Restaurant restaurant) {
        ...
        final Optional<List<RestaurantEntity>> restaurantEntities = restaurantJpaRepository.findByRestaurantIdAndProductIdIn(restaurant.getId().getValue(), restaurantProducts);
